...
class GetAvailableCustomersTestCase(unittest.TestCase):
    def setUp(self):
        os.environ["TESTING"] = "true"
        app = Flask(__name__)
        api = Api(app)
        api.add_resource(GetAvailableCustomers, '/customers/available')
    ...
    def test_get_customers(self, mock_db_session):
        ...
        response = self.app.get('/customers/available')
